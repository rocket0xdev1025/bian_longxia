(() => {
  ...
  function d(t) {
    ...
    a.classList.add("decor-box__decor-item"),
      a.classList.add(
        (function () {
          let t;
          return (t = e() < 40 ? "orange" : "white"), t;
        })()
      ),
      a.classList.add(
        (function () {
          let t;
          return (t = e() < 40 ? "left" : "right"), t;
        })()
      );
  ...
  new (class {
    ...
    d(".about__decor-box"),
    d(".how__decor-box"),
    d(".tokenomics__decor-box"),
    d(".economic__decor-box"),
    d(".holding__decor-box"),
    d(".ride__decor-box"),
    d(".what__decor-box"),
    d(".join__decor-box"),
    setInterval(() => {
